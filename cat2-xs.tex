...
\textcolor{blue}{gap> iso82[3];}
cat2-group with generating (pre-)cat1-groups:
1 : [Group( [ f1, f2, f3 ] ) => Group( [ <identity> of ..., <identity> of ... 
 ] )]
2 : [Group( [ f1, f2, f3 ] ) => Group( [ f2, f2 ] )]
\textcolor{blue}{gap> IsomorphismCat2Groups( all82[3], all82[10] ) = fail;}
false
\end{Verbatim}

In the following table the groups of size at most $30$ are ordered by their
\textsf{GAP} number. 
The number of isomorphism classes of cat$^{1}$-groups given by \cite{alp2}. 
...
the only endomorphisms are the identity and zero maps. 
...
When $G = C_{p^{k}q^{j}}$ is cyclic with $p,q$ distinct primes 
...
\begin{longtable}{ccccccc}
	...
	& $G$ & $|\mathrm{IE}(G)|$ & $|\mathcal{C}(G)|$ & $|\mathcal{C}/\cong |$ & $|%
	\mathcal{C}^{2}(G)|$ & $|\mathcal{C}^{2}/\cong |$ \\ \hline
	& $C_{p^{k}q^{j}}$ & 4 & 4 & 4 & 10 & 10 \\ \hline
	\multicolumn{7}{l}{%
		\begin{tabular}{ll}
			groups  & $[G,I,I,I],~ [G,I,C_p,I],~ [G,I,C_q,I],~ [G,I,G,I],$\\
					& $[G,C_p,C_p,C_p],~ [G,C_p,C_q,I],~ [G,C_p,G,C_p],$\\
					& $[G,C_q,C_q,C_q],~ [G,C_q,G,C_q],~ [G,G,G,G]$%
		\end{tabular}%
	} \\ \hline
\end{longtable}
...
Let $G=C_{2p}\times C_{2}$ with $p>2$ and $p$ prime 
(e.g. $C_{6} \times C_{2}, C_{10} \times C_{2}, C_{14} \times C_{2}, \ldots$). 

\textcolor{red}{[Do we want to include the lengthy groups list for this case?]} 
...
\begin{longtable}{ccccccc}
	...
	& $G$ & $|\mathrm{IE}(G)|$ & $|\mathcal{C}(G)|$ & $|\mathcal{C}/\cong |$ & $|%
	\mathcal{C}^{2}(G)|$ & $|\mathcal{C}^{2}/\cong |$ \\ \hline
	& $C_{2p}\times C_{2}$ & 16 & 28 & 8 & 136 & 32 \\ \hline
	\multicolumn{7}{l}{%
		\begin{tabular}{ll}
			groups 
& $[G,I,I,I],~ [G,I,C_2,I],~ [G,I,C_2,I],~ [G,C_2,C_2,C_2],~ [G,C_2,C_2,I],$ \\ 
& $[G,I,C_2 \times C_2,I],~ [G,C_2,C_2 \times C_2,C_2],~ [G,C_2,C_2 \times C_2,C_2],$ \\ 
& $[G,C_2 \times C_2,C_2 \times C_2,C_2 \times C_2],~ [G,I,C_p,I],~ [G,C_2,C_p,I],$ \\ 
& $[G,C_2,C_p,I],~ [G,C_2 \times C_2,C_p,I],~ [G,C_p,C_p,C_p],~ [G,I,C_{2p},I],$ \\ 
& $[G,I,C_{2p},I],~ [G,C_2,C_{2p},C_2],~ [G,C_2,C_{2p},I],~ [G,C_2 \times C_2,C_{2p},C_2],$ \\ 
& $[G,C_2 \times C_2,C_{2p},C_2],~ [G,C_p,C_{2p},C_p],~ [G,C_p,C_{2p},C_p],$ \\ 
& $[G,C_{2p},C_{2p},C_{2p}],~ [G,C_{2p},C_{2p},C_p],~ [G,C_2 \times C_2,C_{2p} \times C_2,C_2 \times C_2],$ \\ 
& $[G,C_2,C_{2p} \times C_2,C_2],~ [G,C_2,C_{2p} \times C_2,C_2],~ [G,C_p,C_{2p} \times C_2,C_p],$ \\ 
& $[G,C_{2p},C_{2p} \times C_2,C_{2p}],~ [G,C_{2p},C_{2p} \times C_2,C_{2p}],~ [G,G,G,G]$ 
		\end{tabular}%
	} \\ \hline
\end{longtable}
...
\begin{longtable}{ccccccc}
	...
	8/3 & D8 & 10 & 9 & 3 & 21 & 6 \\ 
	8/4 & Q8 & 2 & 1 & 1 & 1 & 1 \\ 
	8/5 & C2 $\times $ C2 $\times $ C2 & 58 & 226 & 6 & 1711 & 23 \\ 
	...
	24/15 & C6 $\ltimes $ K4 & 116 & 452 & 12 & 6786 & 84 \\ 
	...
	27/5 & C3 $\times $ C3 $\times $ C3 & 236 & 2108 & 6 & 24222  & 16 \\ 
	28/1 & Q28 & 9 & 8 & 2 & 15 & 3 \\ 
	28/3 & D28 & 41 & 24 & 4 & 89 & 10 \\ 
	30/1 & D6 $\times $ C5 & 10 & 8 & 4 & 24 & 10 \\ 
	30/2 & D10 $\times $ C3 & 14 & 12 & 4 & 38 & 10 \\ 
	30/3 & D30 & 25 & 24 & 4 & 92 & 10 \\ 
	30/4 & C30 & 8 & 8 & 8 & 36 & 36 \\ \hline
\end{longtable}
%}
