...
It contains tables listing the $993$ \textcolor{red}{(?)} 
...
\textcolor{red}
{Here is a second attempt at the introduction. 
Some more of the papers in the bibliography have been referenced,  
but the following are still not cited. 
Maybe some of these can be omitted? 
I've added some comments of a topological nature on page 2, 
but am not at all sure they are correct, whether they should be included, etc. 
I'm getting tired of working on this introduction, 
so would welcome some feedback or other contributions. 
Some further corrections have been made throughout the text.} 
\textcolor{red}
{\begin{itemize}
\item
...
In section 5 we enumerate the $993$ 
\textcolor{red}{(was $1.065$ - please check!)} isomorphism 
...
So the tenth class consists of cat$^2$-group numbers $[31,34,35,38]$, 
and \texttt{iso82[10]=all82[31]}. 
...
\textcolor{red}{(the previous line and the groups entries in the tables 
