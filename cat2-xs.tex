...
and was first described in \cite{alp3}. 
...
\begin{thebibliography}{99}
	...
	^1 $-algebras in \GAP\, \emph{Version 1.12 Manual for the \textsf{%
			XModAlg} share package for \GAP\ 4 }, (2015).
	...
	Crossed Modules and Cat$^{1}$-groups in \GAP\, 
	    \emph{Manual for the \XMod\ package for \textsf{GAP4}, 
	    version 2.74,} (2019).
\end{thebibliography}
